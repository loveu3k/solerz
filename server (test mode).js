...
// This logic checks if we are in production. If not, it loads the development .env file.
...
// Initialize Stripe with the key from your environment file
...
app.post('/api/stripe-webhook', async (req, res) => {
    ...
    if (event.type === 'customer.subscription.updated') {
        ...
        // --- AMENDED ---
        // This now uses `subscription.cancel_at` which is the correct field for this event.
